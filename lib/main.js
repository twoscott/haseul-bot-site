...
var COMMANDS = {
  ...
  "VLIVE": [{
    cmds: [{ name: "vlive" }, { name: "channel", aliases: ['channelinfo'] }],
  ...
  "Custom Commands": [{
    cmds: [{ name: "command", aliases: ['cmd'] }, { name: "add" }],
    ...
    cmds: [{ name: "command", aliases: ['cmd'] }, { name: "remove", aliases: ['delete'] }],
    args: [{ name: "[command name]", examples: ["chuuhug"] }],
    desc: "Removes a command under the given command name."
  }, {
    cmds: [{ name: "command", aliases: ['cmd'] }, { name: "rename" }],
    ...
    cmds: [{ name: "command", aliases: ['cmd'] }, { name: "edit" }],
    ...
    cmds: [{ name: "command", aliases: ['cmd'] }, { name: "list" }],
    desc: "Shows a list of all the commands in the server."
  }, {
    cmds: [{ name: "command", aliases: ['cmd'] }, { name: "search" }],
