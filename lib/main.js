...
var COMMANDS = {
  ...
  "Instagram": [{
    cmds: [{ name: "instagram", aliases: ['insta'] }, { name: "notification", aliases: ['notif', 'noti'] }, { name: "add" }],
    ...
    cmds: [{ name: "instagram", aliases: ['insta'] }, { name: "notification", aliases: ['notif', 'noti'] }, { name: "remove", aliases: ['delete'] }],
    ...
    cmds: [{ name: "instagram", aliases: ['insta'] }, { name: "toggle" }, { name: "stories", aliases: ['story'] }],
    args: [{ name: "[instagram account]", examples: ["loonatheworld", "<a>https://www.instagram.com/loonatheworld/</a>"] }, { name: "[channel]", examples: ["<span class=\"discord-tag\" >#instagram-feed</span>", '482750802377703426'] }],
  ...
  "VLIVE": [{
    cmds: [{ name: "vlive" }, { name: "channel", aliases: ['channelinfosudi'] }],
    ...
    cmds: [{ name: "vlive" }, { name: "notification", aliases: ['notif', 'noti'] }, { name: "add" }],
    ...
    cmds: [{ name: "vlive" }, { name: "notification", aliases: ['notif', 'noti'] }, { name: "remove", aliases: ['delete'] }],
    ...
    cmds: [{ name: "vlive" }, { name: "notification", aliases: ['notif', 'noti'] }, { name: "list" }],
    desc: "Shows a list of all the VLIVE notifications you have in the server.",
    perms: ["MANAGE_GUILD", "MANAGE_CHANNELS"]
  }, {
    cmds: [{ name: "vlive" }, { name: "toggle" }, { name: "vpick" }],
    args: [{ name: "[vlive channel]", examples: ["LOONA", "<a>https://channels.vlive.tv/E1F3A7/home</a>"] }, { name: "[discord channel]", examples: ["<span class=\"discord-tag\" >#vlive-feed</span>", '482750802377703426'] }],
  ...
  "Member Logs": [{
    cmds: [{ name: "joinlogs", aliases: ['memberlogs', 'joins'] }, { name: "channel" }, { name: "set" }],
    ...
    cmds: [{ name: "joinlogs", aliases: ['memberlogs', 'joins'] }, { name: "toggle" }],
  ...
  "Management": [{
    ...
    cmds: [{ name: "edit" }],
    args: [{ name: "[channel]", examples: ["<span class=\"discord-tag\" >#general-chat</span>", '482759670637789205'] }, { name: "[message ID]", examples: ['612019141813207051'] }, { name: "[new content]", examples: ['Hello! Welcome~'] }],
    desc: "Edits a message from Haseul Bot.",
    perms: ["MANAGE_GUILD", "MANAGE_MESSAGES"]
  }, {
    cmds: [{ name: "get" }],
    args: [{ name: "[channel]", examples: ["<span class=\"discord-tag\" >#welcome</span>", '482759670637789205'] }, { name: "[message ID]", examples: ['491062821564448778'] }],
